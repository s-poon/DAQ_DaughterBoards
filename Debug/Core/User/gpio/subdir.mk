...
OBJS += \
./Core/User/gpio/GPIOPin.o \
./Core/User/gpio/exti.o 

CPP_DEPS += \
./Core/User/gpio/GPIOPin.d 


# Each subdirectory must supply rules for building sources it contributes
Core/User/gpio/%.o Core/User/gpio/%.su Core/User/gpio/%.cyclo: ../Core/User/gpio/%.cpp Core/User/gpio/subdir.mk
...
clean-Core-2f-User-2f-gpio:
	-$(RM) ./Core/User/gpio/GPIOPin.cyclo ./Core/User/gpio/GPIOPin.d ./Core/User/gpio/GPIOPin.o ./Core/User/gpio/GPIOPin.su ./Core/User/gpio/exti.cyclo ./Core/User/gpio/exti.d ./Core/User/gpio/exti.o ./Core/User/gpio/exti.su
