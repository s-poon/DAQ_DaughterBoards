  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = ANALOG_2_Pin|ANALOG_5_Pin|ANALOG_6_Pin|ANALOG_7_Pin
                          |ANALOG_8_Pin|ANALOG_3_Pin|ANALOG_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(FIRMWARECHECK_GPIO_Port, FIRMWARECHECK_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOD, ANALOG_2_Pin|ANALOG_5_Pin|ANALOG_6_Pin|ANALOG_7_Pin
                          |ANALOG_8_Pin|ANALOG_3_Pin|ANALOG_4_Pin);
